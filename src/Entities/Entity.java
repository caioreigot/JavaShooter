...
public class Entity {
	...
	public static BufferedImage GUN_UP = Game.spritesheet.getSprite(96, 32, 16, 16);
	...
	public static BufferedImage GUN_DAMAGE_UP = Game.spritesheet.getSprite(96, 48, 16, 16);
	public static BufferedImage GUN_DAMAGE_DOWN = Game.spritesheet.getSprite(112, 48, 16, 16);
